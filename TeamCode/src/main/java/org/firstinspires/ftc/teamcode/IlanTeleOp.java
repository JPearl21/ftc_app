...
public class IlanTeleOp extends OpMode {
    /*
    Part declarations.
    ...
    */
    ...
    private int TickCountForPickingUpMinerals;
    private String Pos;
    //private List<Integer> TickCounts;


    // Code to run after init is hit
    public void init(){
        TickCountForPickingUpMinerals = 20; //Edit
        Pos = "Down";
        /*
    ...
    public void loop(){
        ...
        if (gamepad2.dpad_down) {
            if (Pos == "Down") {
                pEncoderMotorRun(0.001, -4048, arm); //Go to lander position
                Pos = "Lander";
            } else if (Pos == "Lander") {
                pEncoderMotorRun(0.001, TickCountForPickingUpMinerals, arm); //Go to ground position
                Pos = "Ground";
            }
        }
        if (gamepad2.dpad_up) {
